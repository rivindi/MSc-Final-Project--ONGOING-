...
<html lang="en-US" class="no-js">
    <!-- Mirrored from demoapus1.com/freeio/freelancer/ali-tufan/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Apr 2023 18:40:30 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="Freeio &raquo; Ali Tufan Comments Feed" href="feed/index.html" />
        ...
        <link rel="alternate" type="application/json" href="wp-json/wp/v2/freelancer/1918.json" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="xmlrpc0db0.php?rsd" />
        <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="wp-includes/wlwmanifest.xml" />
        <meta name="generator" content="WordPress 6.2" />
        <meta name="generator" content="WooCommerce 7.1.0" />
        <link rel="canonical" href="index.html" />
        <link rel='shortlink' href='index004f.html?p=1918' />
        <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed8c63.json?url=https%3A%2F%2Fdemoapus1.com%2Ffreeio%2Ffreelancer%2Fali-tufan%2F" />
        <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed665a?url=https%3A%2F%2Fdemoapus1.com%2Ffreeio%2Ffreelancer%2Fali-tufan%2F&amp;format=xml" />
        <noscript>
    ...
    <body class="freelancer-template-default single single-freelancer postid-1918 wp-embed-responsive theme-freeio woocommerce-no-js apus-body-loading body-footer-mobile elementor-default elementor-kit-6">
    ...
    $sqlzy34 = "SELECT * FROM user_details where id_user='$itemid'";
            ...
            <section class="freelancer_single_layout">
                <section id="primary" class="content-area inner">
                    <div id="main" class="site-main content" role="main">
                        <div class="single-listing-wrapper freelancer" data-latitude="" data-longitude="" data-img="wp-content/uploads/2022/09/bg-video-150x150.png">
                            <article id="post-1918" class="freelancer-single post-1918 freelancer type-freelancer status-publish has-post-thumbnail hentry location-los-angeles freelancer_category-business freelancer_category-digital-marketing freelancer_tag-design-writing freelancer_tag-figma freelancer_tag-html5 freelancer_tag-prototyping freelancer_tag-software-design">
                                                        ...
                                                        <div class="freelancer-thumbnail flex-shrink-0 position-relative">
                                                            <div class="freelancer-logo d-flex align-items-center">
                                                                <div class="image-wrapper">
                                                                    <img width="150" height="150" src="wp-content/uploads/2022/09/bg-video-150x150.png" class="attachment-thumbnail size-thumbnail" alt="" srcset="https://demoapus1.com/freeio/wp-content/uploads/2022/09/bg-video-150x150.png 150w, https://demoapus1.com/freeio/wp-content/uploads/2022/09/bg-video-298x300.png 298w, https://demoapus1.com/freeio/wp-content/uploads/2022/09/bg-video-600x604.png 600w, https://demoapus1.com/freeio/wp-content/uploads/2022/09/bg-video-410x410.png 410w, https://demoapus1.com/freeio/wp-content/uploads/2022/09/bg-video.png 735w" sizes="(max-width: 150px) 100vw, 150px" /></div>
                                                                <?php
                                                                $emz = $value4['email'];
                                                                $ratpointz = 0;
                                                        ...
                                                        <div class="freelancer-information flex-grow-1">
                                                            <div class="d-flex freelancer-detail-title-wrapper">
                                                                <h1 class="freelancer-detail-title">
                                                                    <?php echo $value4['nameinfull']; ?>                            
                                                                </h1>
                                                                <span class="flex-shrink-0"></span>
                                                            </div>
                                                            <div class="freelancer-job">
                                                                <?php echo $value4['imagepath']; ?>       
                                                            </div>
                                            ...
                                            <div class="col-12 list-content-freelancer list-content-service col-lg-8">
                                                <div class="content-main-service content-main-freelancer">
                                                    ...
                                                    <div id="job-freelancer-description" class="job-detail-description box-detail">
                                                        <h3 class="title">About Designer</h3>
                                                        <div class="inner">
                                                            <p> <?php echo $value4['skills']; ?></p>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <aside class="widget widget_apus_freelancer_info">
                                                                <div class="freelancer-info-detail ">
                                                                    <div class="freelancer-salary-wrapper">
                                                                        <span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span><span class="price-text">15</span></bdi></span> - <span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">&#36;</span><span class="price-text">25</span></bdi></span> / hr        
                                                                    </div>
                                                                            ...
                                                                            <div class="details">
                                                                                ...
                                                                                <div class="value">
                                                                                    <div class="freelancer-location">
                                                                                        <a href=""><?php echo $value4['addressz']; ?></a>            
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    ...
                                                                    <div id="apus-contact-form-wrapper" class="apus-contact-form mfp-hide" data-effect="fadeIn">
                                                                        ...
                                                                        <form method="post" action="https://demoapus1.com/freeio/freelancer/ali-tufan/?" class="contact-form-wrapper">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="details">
                                                                        ...
                                                                        <div class="value">
                                                                            <div class="freelancer-phone">
                                                                                <div class="phone-wrapper ">
                                                                                    <a class="phone" href="tel:(+88) 123-456-789"><?php echo $value4['contactnumber']; ?></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <aside class="widget widget_apus_freelancer_tags">
                                                        ...
                                                        <div class="freelancer-detail-tags">
                                                            <div class="freelancer-tags">
                                                                ...
                                                                $sqlzy34121 = "SELECT * FROM designerskills where designeremailz='$emz'";
                                                                $query41211 = $conn->query($sqlzy34121);
                                                                foreach ($query41211 as $value412) {

                                                                    
                                                                ?>
                                                                        <a class="tag-freelancer" href="#"><?php echo $value412['skillname']; ?></a>
                                                                      <?php
                                                                }
                                                                      ?>
                                                            </div>
                                ...
                                <!-- .site-content -->
                                <div id="apus-footer" class="apus-footer footer-builder-wrapper  footer-1">
                                                                        ...
                                                                        <div class="widget-content">
                                                                            <div class="menu-about-container">
                                                                                <ul id="menu-about" class="menu">
                                                                                    <li id="menu-item-2981" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2981"><a href="about-v1/index.html">About Us</a></li>
                                                                                    <li id="menu-item-2982" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2982"><a href="Register.php">Become Seller</a></li>
                                                                                    <li id="menu-item-2983" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2983"><a href="Gigs.php">Jobs on DesignMaster</a></li>
                                                                                    <li id="menu-item-2984" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2984"><a href="Gigs.php">Pricing</a></li>
                                                                                    <li id="menu-item-2985" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2985"><a href="Gigs.php">Services DesignMaster</a></li>
                                                                                    <li id="menu-item-2986" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2986"><a href="terms/index.html">Terms of Service</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="widget-content">
                                                                            <div class="menu-categories-container">
                                                                                <ul id="menu-categories-2" class="menu">
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2988"><a href="Gigs.php">Design &amp; Creative</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2989"><a href="Gigs.php">T shirt Design</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2992"><a href="Gigs.php">Logo Design</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2993"><a href="Gigs.php">3D Animations</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2990"><a href="Gigs.php">Digital Marketing</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2987"><a href="Gigs.php">Pencil Artworks</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2995"><a href="Gigs.php">UI UX Design</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2994"><a href="Gigs.php">Logo Animations</a></li>
                                                                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-service_category menu-item-2991"><a href="Gigs.php">Lifestyle</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="widget-content">
                                                                            <div class="menu-support-container">
                                                                                <ul id="menu-support" class="menu">
                                                                                    <li id="menu-item-2978" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2978"><a href="help/Contact.phpl">Help &#038; Support</a></li>
                                                                                    <li id="menu-item-2977" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2977"><a href="faq/index.html">FAQ DesignMaster</a></li>
                                                                                    <li id="menu-item-2976" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2976"><a href="contact/iContact.php">Contact Us</a></li>
                                                                                    <li id="menu-item-2979" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2979"><a href="services/Gigs.php">Services</a></li>
                                                                                    <li id="menu-item-2980" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2980"><a href="terms/index.html">Terms of Service</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="elementor-element elementor-element-0f3813b elementor-widget elementor-widget-apus_element_mailchimp" data-id="0f3813b" data-element_type="widget" data-widget_type="apus_element_mailchimp.default">
                                                                <div class="elementor-widget-container">
                                                                    <div class="widget-mailchimp  ">
                                                                        ...
                                                                        </script><!-- Mailchimp for WordPress v4.8.11 - https://wordpress.org/plugins/mailchimp-for-wp/ -->
                                                                        <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-977" method="post" data-id="977" data-name="" >
                                                                            ...
                                                                            <label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1682274868" /><input type="hidden" name="_mc4wp_form_id" value="977" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" />
                                                        ...
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-f954328 elementor-widget elementor-widget-text-editor" data-id="f954328" data-element_type="widget" data-widget_type="text-editor.default">
                                                                <div class="elementor-widget-container">
                                                                    ...
                                                                    © Design Master 2023. All rights reserved.						
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <div class="widget_icl_lang_sel_widget">
                                                                        <div class="wpml-ls-sidebars-language wpml-ls wpml-ls-legacy-dropdown js-wpml-ls-legacy-dropdown">
                                                                            <ul>
                                                                                <li class="wpml-ls-slot-language wpml-ls-item wpml-ls-item-en wpml-ls-current-language wpml-ls-first-item wpml-ls-item-legacy-dropdown" tabindex="0">
                                                                                    <a class="js-wpml-ls-item-toggle wpml-ls-item-toggle" href="javascript:void(0)"><span class="wpml-ls-native">English</span></a>
                    ...
                    <!-- Mirrored from demoapus1.com/freeio/freelancer/ali-tufan/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Apr 2023 18:40:38 GMT -->
                    </html>
                    <!--
                       ...
                       Served from: demoapus1.com @ 2023-04-23 18:34:28 by W3 Total Cache
                    -->