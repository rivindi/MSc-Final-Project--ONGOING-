...
<html lang="en-US" class="no-js">
    ...
    <head>
        ...
        <title>Gigs &#8211; Design Master</title>
        ...
        <script type="text/javascript">
            window._wpemojiSettings = {
                ...
                svgExt: ".svg",
                source: {
                    concatemoji: "https:\/\/demoapus1.com\/freeio\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.2"
                },
            };
        ...
        <link rel="alternate" type="application/json" href="wp-json/wp/v2/pages/5143.json" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="xmlrpc0db0.php?rsd" />
        <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="wp-includes/wlwmanifest.xml" />
        <meta name="generator" content="WordPress 6.2" />
        <meta name="generator" content="WooCommerce 7.1.0" />
        <link rel="canonical" href="index.html" />
        <link rel="shortlink" href="indexc9e1.html?p=5143" />
        <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed53f7.json?url=https%3A%2F%2Fdemoapus1.com%2Ffreeio%2Fservice-layout-2%2F" />
        <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embedfc19?url=https%3A%2F%2Fdemoapus1.com%2Ffreeio%2Fservice-layout-2%2F&amp;format=xml" />
        <noscript>
        <style>
    ...
    <body class="page-template page-template-page-services page-template-page-services-php page page-id-5143 wp-embed-responsive theme-freeio woocommerce-no-js main apus-body-loading body-footer-mobile elementor-default elementor-kit-6">
        ...
        <div class="row">
            <div id="main-content" class="col-12 col-12">
                <main id="main" class="site-main layout-type-default" role="main">
                    <div class="services-listing-wrapper main-items-wrapper" data-display_mode="list">
                        <div class="wrapper-fillter">
                            <div class="apus-listing-filter d-sm-flex align-items-center">
                                <div class="results-count">Showing  <span class="last">All</span>  results </div>
                        ...
                        <div class="services-wrapper items-wrapper">
                            <div class="row items-wrapper-list">
                                ...
                                $sqlzy34 = "SELECT * FROM designerpostitem where statusz='posted' and gigtags like '%$itemid%' ORDER BY id DESC";
                                $query4 = $conn->query($sqlzy34);

                                foreach ($query4 as $value4) {
                                    ?>
                                    <div class="item-service col-md-6 col-xl-6 col-12" onclick="singleproductdetail(<?php echo $value4['id']; ?>)">
                                        <article class="map-item service-item list position-relative post-5557 service type-service status-publish has-post-thumbnail hentry location-new-york service_category-development-it service_category-programming-tech" data-latitude="40.77229478697032" data-longitude="-73.92725741145593" data-img="https://demoapus1.com/freeio/wp-content/uploads/2022/11/service12-495x370.jpg" data-logo="../wp-content/uploads/2022/11/service12-150x150.jpg">
                                            <div class="d-sm-flex align-items-center">
                                                <div class="position-relative service-top flex-shrink-0">
                                                    <div class="service-image">
                                                        <a onclick="singleproductdetail(<?php echo $value4['id']; ?>)">
                                                            <div class="image-wrapper">
                                                                <img width="495" height="370" src="Phpfiles/<?php echo $value4['imgurl']; ?>" class="attachment-freeio-listing-grid size-freeio-listing-grid" alt="" srcset="Phpfiles/<?php echo $value4['imgurl']; ?>" sizes="(max-width: 495px) 100vw, 495px" />
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="service-information flex-grow-1">
                                                    <div class="category-service">
                                                        <a href="" style=""><?php echo $value4['catoz']; ?></a>
                                                    </div>
                                                    <h2 class="service-title">
                                                        <a href="" rel="bookmark"><?php echo $value4['gigtitle']; ?></a>
                                                    </h2>
                                                        ...
                                                        <div class="service-author">
                                                            <a href="">
                                                                ...
                                                                <div class="freelancer-logo d-flex align-items-center">
                                                                    <div class="image-wrapper">
                                                                        <img width="150" height="150" src="CustomImages/programmer.png" class="attachment-thumbnail size-thumbnail" alt="" srcset="CustomImages/programmer.png" sizes="(max-width: 150px) 100vw, 150px" />
                                                                        <?php
                                                                        if ($ratpointz > 300) {
                                                                            ?>
                                                                ...
                                                                <span class="text"> <?php echo $value4['designernamez']; ?> </span>
                                                            </a>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="service-salary with-title">
                                                                ...
                                                                <span>
                                                                    <span class="woocommerce-Price-amount amount">
                                                                        <bdi>
                                                                            <span class="woocommerce-Price-currencySymbol">LKR</span>
                                                                            <span class="price-text"><?php echo $value4['gigprice']; ?> </span>
                                                                        </bdi>
                                                                    </span>
                                                                </span>
                                                            </div>
                                            ...
                                            <a onclick="singleproductdetail(<?php echo $value4['id']; ?>)" class="btn-add-service-favorite" data-service_id="5557" data-nonce="4c55c09adb" data-bs-toggle="tooltip" title="View Gig">
...
<script>
    ...
    function singleproductdetail(cc) {
        ...
        var url = "singleviewGig.php?itemidz=" + itemid;
...
<link rel="stylesheet" id="elementor-post-1984-css" href="wp-content/uploads/elementor/css/post-19848a7a.css?ver=1669099556" type="text/css" media="all" />
...
<script type="text/javascript" src="wp-content/plugins/wp-freeio/assets/js/leaflet/esri-leafletcc1a.js?ver=1.5.1" id="esri-leaflet-js"></script>
<script type="text/javascript" src="wp-content/plugins/wp-freeio/assets/js/leaflet/esri-leaflet-geocodercc1a.js?ver=1.5.1" id="esri-leaflet-geocoder-js"></script>
...
<script type="text/javascript" id="elementor-frontend-js-before">
    var elementorFrontendConfig = {
        ...
        post: {
            id: 5143,
            title: "Service%20Layout%202%20%E2%80%93%20Freeio",
            excerpt: "",
            featuredImage: false
        },
    };
