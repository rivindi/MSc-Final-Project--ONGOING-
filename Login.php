...
<html lang="en-US" class="no-js">
    ...
    <head>
        ...
        <title>Login &#8211; Design Master</title>
        ...
        <link rel="stylesheet" id="elementor-post-1876-css" href="wp-content/uploads/elementor/css/post-1876e630.css?ver=1669468321" type="text/css" media="all" />
        ...
        <link rel="alternate" type="application/json" href="wp-json/wp/v2/pages/1876.json" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="xmlrpc0db0.php?rsd" />
        <link rel="wlwmanifest" type="application/wlwmanifest+xml" href="wp-includes/wlwmanifest.xml" />
        <meta name="generator" content="WordPress 6.2" />
        <meta name="generator" content="WooCommerce 7.1.0" />
        <link rel="canonical" href="index.html" />
        <link rel="shortlink" href="index26b6.html?p=1876" />
        <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embedd672.json?url=https%3A%2F%2Fdemoapus1.com%2Ffreeio%2Flogin%2F" />
        <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed8b7d?url=https%3A%2F%2Fdemoapus1.com%2Ffreeio%2Flogin%2F&amp;format=xml" />
        <noscript>
        <style>
    ...
    <body class="page-template-default page page-id-1876 wp-embed-responsive theme-freeio woocommerce-no-js main apus-body-loading body-footer-mobile elementor-default elementor-kit-6 elementor-page elementor-page-1876">
   ...
   ?>
                    ...
                    <div id="main-content" class="main-page col-12">
                        <div id="main" class="site-main clearfix" role="main">
                            <div data-elementor-type="wp-page" data-elementor-id="1876" class="elementor elementor-1876">
                                <section
                                    class="elementor-section elementor-top-section elementor-element elementor-element-6b75c71 elementor-section-stretched elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                    data-id="6b75c71"
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-1dbf705 elementor-widget elementor-widget-heading" data-id="1dbf705" data-element_type="widget" data-widget_type="heading.default">
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h2 class="elementor-heading-title elementor-size-default">System LogIn</h2>
                                                    </div>
                                                </div>
                                                <div class="elementor-element elementor-element-1633370 elementor-widget elementor-widget-text-editor" data-id="1633370" data-element_type="widget" data-widget_type="text-editor.default">
                                                    <div class="elementor-widget-container">
                                                        <style>
                                                            /*! elementor - v3.8.1 - 13-11-2022 */
                                                        ...
                                                        <div class="elementor-shortcode">
                                                            <div class="box-account">
                                                                <div class="login-form-wrapper">
                                                                    <div id="login-form-wrapper5829" class="form-container">



                                                                        <div class="form-group">
                                                                            <label>Email</label>
                                                                            <input autocomplete="off" type="text" name="username" class="form-control" id="p1" placeholder="Email" />
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Password</label>
                                                                            <span class="show_hide_password">
                                                                                <input name="password" type="password" class="password required form-control" id="p2" placeholder="Password" />
                                                                        ...
                                                                        <div class="form-group">
                                                                            <button style="background-color: #0062cc; margin-top: 2px; width: 100%; border-radius: 5px !important; color: #fff;" onclick="Loginuserss()">
                                                                                Login<i class="flaticon-right-up next"></i>
                                                                            </button>
                                                                        </div>
    ...
    <script>
        ...
        function rideirecttoShop() {
            ...
            window.location = "EmployerHome.php";
        }
        
        function sellerDashboard() {

            window.location = "DesignerHome.php";
        }
    </script>
    <script>
    ...
    <script type="text/javascript" id="elementor-frontend-js-before">
        var elementorFrontendConfig = {
            ...
            post: {id: 1876, title: "Login%20%E2%80%93%20Freeio", excerpt: "", featuredImage: false},
        };
    </script>
