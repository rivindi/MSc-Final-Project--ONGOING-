                                                            ...
                                                            <div class="item col-12 col-sm-12">
                                                                <div class="item-address d-flex style2">
                                                                    ...
                                                                    <div class="address-box-content flex-grow-1">
                                                                        ...
                                                                        <div class="description">328 Queensberry Street, North<br> Melbourne VIC 3051, Australia.</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="item col-12 col-sm-12">
                                                                <div class="item-address d-flex style2">
                                                                    ...
                                                                    <div class="address-box-content flex-grow-1">
                                                                        ...
                                                                        <div class="description">+(088) 123 456 789</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="item col-12 col-sm-12">
                                                                <div class="item-address d-flex style2">
                                                                    ...
                                                                    <div class="address-box-content flex-grow-1">
                                                                        ...
                                                                        <div class="description">hello@freeio.com</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-shortcode">
                                                        <div role="form" class="wpcf7" id="wpcf7-f1726-p49-o1" lang="en-US" dir="ltr">
                                                            ...
                                                            <div class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <span class="wpcf7-form-control-wrap" data-name="your-message">
                                                                            <input class="form-control" type="text" placeholder="Your Message" style="height: 150px;" id="ff1zz">
                                                                        </span>
                                                                    </div>
                                                                    <br>
                                                                    <br>
                                                                    <div class="col-12">
                                                                        ...
                                                                        <br>
                                                                        <br>
                                                                        <button class="btn btn-theme btn-inverse" type="button" onclick="contadmin()" id="sendbtn">Send<i class="flaticon-right-up next"></i></button>
                                                                    </div>
                                                                </div>
                                                                <br>
...
<script>
                                                                            function contadmin() {
                                                                                ...
                                                                                if (namez == "") {
                                                                                    ...
                                                                                    swal({
                                                                                        title: "Are you sure?",
                                                                                        text: "You want to send this message to Admin?",
                                                                                        icon: "warning",
                                                                                        buttons: true,
                                                                                        dangerMode: true,
                                                                                    })
                                                                                            .then(function(willDelete) {
                                                                                                if (willDelete) {
                                                                                                    ...
                                                                                                    $.post("phpfiles/contactadmin.php",
                                                                                                            {
                                                                                                                namez: namez
                                                                                                            },
                                                                                                    function(data, status) {
                                                                                                        if (data == "ok") {
                                                                                                            ...
                                                                                                            swal("Done!Employer Removed..!", {
                                                                                                                icon: "success",
                                                                                                            });

                                                                                                            window.location = "AllEmployers.php";
